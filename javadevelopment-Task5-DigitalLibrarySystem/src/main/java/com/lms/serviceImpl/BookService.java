...
public class BookService implements IBookService {
    ...
    public List<BookDto> searchBookByTitle(String title) {
        return convertList( bookRepository.findByTitleContainingIgnoreCase(title));

    }

    @Override
    public List<BookDto> searchBookByAuthor(String author) {
        return convertList(bookRepository.findByAuthorContainingIgnoreCase(author));
    }

    @Override
    public List<BookDto> searchBookByCategory(BookCategory category) {
        return convertList(bookRepository.findByCategory(category));

    }

    @Override
    public BookDto updateBookTitle(Integer bookId,String title) {
    ...
    @Override
    public BookDto updateBookAuthor(Integer bookId,String author) {
        Book book =getBook(bookId);
    ...
    @Override
    public BookDto updateBookISBN(Integer bookId,String isbn) {
        Book book =getBook(bookId);
        Optional<Book> existing = bookRepository.findByIsbn(isbn);
        if(existing.isPresent() && !existing.get() .getBookId() .equals(bookId)) {
    ...
    @Override
    public BookDto updateBookCategory(Integer bookId,BookCategory category) {
        Book book = getBook(bookId);
    ...
    @Override
    public BookDto addBookStock(Integer bookId,Integer quantity) {
        Book book =getBook(bookId);
